...
// Query the database
$stmt = $pdo->prepare("SELECT accession, description, organism, sequence, seq_length FROM user_sequences WHERE id = ?");
$stmt->execute([$id]);
...
?>
    ...
    <p>
        <a href="javascript:history.back()">Back to Analysis Results</a>
    </p>
